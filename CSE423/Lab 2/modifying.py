...
def draw_shooter():
    # Draw the rocket's body (rectangle)
    DrawLine(shooter_x - shooter_width // 2, shooter_y, shooter_x + shooter_width // 2, shooter_y)  # Top line
    DrawLine(shooter_x + shooter_width // 2, shooter_y, shooter_x + shooter_width // 2, shooter_y + shooter_height)  # Right line
    DrawLine(shooter_x + shooter_width // 2, shooter_y + shooter_height, shooter_x - shooter_width // 2, shooter_y + shooter_height)  # Bottom line
    DrawLine(shooter_x - shooter_width // 2, shooter_y + shooter_height, shooter_x - shooter_width // 2, shooter_y)  # Left line
    
    # Draw the rocket's nose (triangle)
    triangle_height = 20  # Height of the triangular part (nose)
    DrawLine(shooter_x - shooter_width // 2, shooter_y, shooter_x, shooter_y + triangle_height)  # Left side of the triangle
    DrawLine(shooter_x, shooter_y + triangle_height, shooter_x + shooter_width // 2, shooter_y)  # Right side of the triangle
...
#     # Draw the rocket's body (rectangle) below the triangle
#     body_top_y = shooter_y + triangle_height  # The top of the body starts right after the triangle
#     # Top of the rectangle body
#     DrawLine(shooter_x - shooter_width // 2, body_top_y, shooter_x + shooter_width // 2, body_top_y)
#     # Right side of the rectangle body
#     DrawLine(shooter_x + shooter_width // 2, body_top_y, shooter_x + shooter_width // 2, body_top_y + shooter_height)
#     # Bottom of the rectangle body
#     DrawLine(shooter_x + shooter_width // 2, body_top_y + shooter_height, shooter_x - shooter_width // 2, body_top_y + shooter_height)
#     # Left side of the rectangle body
#     DrawLine(shooter_x - shooter_width // 2, body_top_y + shooter_height, shooter_x - shooter_width // 2, body_top_y)
...
def mouse_listener(button, state, x, y):
    ...
    if button == GLUT_LEFT_BUTTON and state == GLUT_DOWN:
        if 10 <= x <= 30 and (600-580) <= y <= (600-560):
            ...
            cross_buttonCon = not cross_buttonCon
            exitTheGame()
